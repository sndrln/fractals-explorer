...
export const FORMULAS: FormulaDefinition[] = [
  ...
  },
  {
    ...
    name: "Nova Sine",
    fractalType: "nova",
    mathNotation: "zₙ - α(sin(P·zₙ) - S) / (P·cos(P·zₙ)) + c",
  ...
  },
  {
    ...
    name: "Nova Hybrid",
    fractalType: "nova",
    mathNotation: "zₙ - a(zᴾ sin z - s)/f' + c",
